...
<div class="p-12 row-start-2 col-span-3 lg:col-span-1">
   <img src="{picture}" alt="" class="h-100 w-100">
...
<div class="row-start-3 lg:row-start-2 p-2 lg:p-12 col-start-1 lg:col-start-2 col-span-3 lg:col-span-1">
   ...
   <p class="dark:text-light_pink">
      Diana B. Tease is Halifax's dashing diabetic diva, and her blood sugar is probably higher than yours. Diana aims to bring drag to unconventional places, and in 2022 she raised $1500 for Easter Seals NS by rappelling down a building in drag. They enjoy sewing, playing video games, and tucking her cat Penny into cozy blankets.
      Diana is a queer activist, founder of Halifax Queer Solidarity Project, co-host of the Gay Expectations podcast, and co-founder of Glitter & Grit Events. </p>

      <div class="flex">
         <a href="https://www.instagram.com/diana.b.tease/">
            <img class="icon" src="{insta}" alt="blah">
         </a>
