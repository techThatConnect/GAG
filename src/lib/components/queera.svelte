...
import pic from '$lib/images/image1.png'
...
<body class="bg-black">
<br>
<div class="card bg-black border-4 border-black  grid grid-rows-2 ml-2 mr-2 sm:ml-12 sm:mr-12  lg:ml-24 lg:mr-24">
